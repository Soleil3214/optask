...
//-main関数-
	...
	Kokyaku *kokyaku1, *kokyaku2, *kokyaku3, *kokyaku4, *kokyaku5;

	camera1 = new Camera("Cobla","red",92000,21);
	syohin.setCamera(camera1,0);

	camera2 = new Camera("Saty","blue",64500,5);
	syohin.setCamera(camera2,1);

	camera3 = new Camera("RedHotMeet","green",86000,17);
	syohin.setCamera(camera3,2);

	pc1 = new PC("電通","pink",110000,21);
	syohin.setPC(pc1,0);

	pc2 = new PC("AMD","purple",59200,5);
	syohin.setPC(pc2,1);

	pc3 = new PC("ANA","black",88000,17);
	syohin.setPC(pc3,2);

	sojiki1 = new Sojiki("NEC","silver",62000,3);
	syohin.setSojiki(sojiki1,0);

	sojiki2 = new Sojiki("Oracle","white",53800,12);
	syohin.setSojiki(sojiki2,1);

	sojiki3 = new Sojiki("TrendMicro","blue",42000,19);
	syohin.setSojiki(sojiki3,2);

	kokyaku1 = new Kokyaku("sakura","gold",149900);
	syohin.setKokyaku(kokyaku1,0);

	kokyaku2 = new Kokyaku("akari","brons",120);
	syohin.setKokyaku(kokyaku2,1);

	kokyaku3 = new Kokyaku("sumire","silver",2100);
	syohin.setKokyaku(kokyaku3,2);

	kokyaku4 = new Kokyaku("hinaki","glay",1400);
	syohin.setKokyaku(kokyaku4,3);
